      ...
      <div className="uz-pattern bg-emerald-900 border-b border-amber-500/30 px-4 md:px-8 py-5">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex items-center gap-3.5">
            <div className="bg-amber-400 p-2.5 rounded-xl border-2 border-emerald-500 shadow-lg text-emerald-950 flex items-center justify-center">
              <span className="font-display font-bold text-xl tracking-wider select-none">MFY</span>
            </div>
            <div>
              ...
              <h1 className="font-display text-2xl md:text-3xl font-extrabold tracking-tight text-white mt-1">
                Oltinko'l MFY <span className="text-amber-400 font-light">Portali</span>
              </h1>
      ...
      <div className="bg-emerald-950 text-emerald-100 px-4 py-2.5 text-xs font-sans border-b border-emerald-800">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-2">
          <div className="flex items-center gap-2">
            ...
            <span>Mahalla qonunchiligiga binoan barcha murojaatlar <strong>bevosita MFY raisi nazoratida</strong> bo'lib, mutlaqo bepul xizmat ko'rsatiladi.</span>
          </div>
