...
import { 
  ...
  Clock, ThumbsUp, Shield, Mask, CheckCircle2, UserRound, ArrowRight
} from 'lucide-react';
...
// Masking helpers for security and privacy
...
export const ComplaintCard: React.FC<ComplaintCardProps> = ({ complaint, onSupport, isAdminView }) => {
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 hover:border-emerald-200 hover:shadow-md transition-all duration-200 overflow-hidden flex flex-col justify-between">
      ...
      <div className="p-4 md:p-5">
        ...
        {/* Mashed citizen privacy credential line */}
        ...
        {/* Assigned mfy official detail row */}
        ...
        {/* Resolution Text (If exists / Solved) */}
