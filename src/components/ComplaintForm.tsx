...
export const ComplaintForm: React.FC<ComplaintFormProps> = ({ onSubmit, selectedMahallaFromMap }) => {
  ...
  // Sync selected mahalla from map changes
  useEffect(() => {
    if (selectedMahallaFromMap) {
      setSelectedMahalla(selectedMahallaFromMap);
    }
  }, [selectedMahallaFromMap]);
  ...
  return (
    <div id="complaint-form-card" className="bg-white rounded-2xl border border-slate-200 shadow-md overflow-hidden font-sans scroll-mt-6">
        ...
        <form onSubmit={handleSubmit} className="p-5 md:p-6 space-y-5">
          ...
          <div className="space-y-4">
            ...
            {selectedMahalla === 'Boshqa' && (
              <div className="bg-amber-50/50 p-3 rounded-lg border border-amber-200/60 transition-all">
          ...
          <p className="text-[10px] text-center text-slate-400">
            Murojaat yuborish orqali siz shaxsiy ma'lumotlaringizni Oltinko'l tumani tizimida maxfiy saqlangan holda qayta ishlashga ruxsat berasiz.
          </p>
